...
-(void)showWithView:(UIView*)view height:(CGFloat)height{
    ...
    CATransform3D transform2 = CATransform3DTranslate(transform1, 0, wHeight / 2.0f, 0);
    transform2 = CATransform3DRotate(transform2, M_PI / 15, 1, 0, 0);
    transform2 = CATransform3DTranslate(transform2, 0, -wHeight / 2.0f, 0);
    _transform2=transform2;
    
    CATransform3D  transform3 = CATransform3DTranslate(transform2, 0, -wHeight/2.0f, 0);
    transform3 = CATransform3DRotate(transform3, -M_PI / 15, 1, 0, 0);
    transform3 = CATransform3DTranslate(transform3, 0, wHeight / 2.0f-80, 0);
